...
** TODO Migrating my blog from Jekyll to Hugo   :blog:jekyll:hugo:
:properties:
:hugo_section: 2022/12/
:export_file_name: Migrating my blog from Jekyll to Hugo.md
:end:
** DONE My 2022 Year Review :blog:yearreview:review:2022:techreview:
