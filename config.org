...
** TODO Today I learnt TIL : How to effectively remove submodules :git:submodule:gitsubmodule:github:til:
:properties:
:hugo_section: posts/2023/01
:export_file_name: The Annoying Case of Git Submodules.md
 :end:
